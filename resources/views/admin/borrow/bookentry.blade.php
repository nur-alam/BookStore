        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{route('admin.borrow.index')}}" method="post" id="addtoborrow">
                        @csrf
                        ...
                        <table id="cart" class="table table-hover table-condensed">
                            ...
                            @forelse($data['borrows'] as $borrow)
                                ...
                                <tr>
                                    ...
                                    <td data-th="Price">
                                        <a href="{{route('admin.borrow.update',[$borrow->user_id,$borrow->book_id] )}}" class="btn btn-danger" onclick="document.getElementById('borrowback').submit()">
